...
public class UserRepositoryTest {
    ...
    @Test
    @Sql(scripts = {"/sql/drop_data.sql", "/sql/insert_user_statuses.sql", "/sql/insert_roles.sql", "/sql/insert_users.sql"})
    void save_shouldInsertUserToDatabase_whenInputContainsUserWithExistingRole() {
        UserStatus userStatus = userStatusRepository.findUserStatusByUserStatusId(1);
        Role role = roleRepository.findRoleByRoleId(1);
        User user = new User("Test user name", "$2a$12$C0oG23YPNxAkgNetSRJ/LuEVZt3TT95ulwjrSbAha4qtvvk6hIahS", "Test email",role, userStatus);
